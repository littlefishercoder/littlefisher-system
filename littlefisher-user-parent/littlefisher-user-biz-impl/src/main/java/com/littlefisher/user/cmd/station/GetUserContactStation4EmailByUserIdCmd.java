...
import com.littlefisher.user.converter.UserContactStation4EmailDtoConverter;
 ...
 */
@Command
public class GetUserContactStation4EmailByUserIdCmd extends
        AbstractCommand<List<UserContactStation4EmailBizDto>> {
