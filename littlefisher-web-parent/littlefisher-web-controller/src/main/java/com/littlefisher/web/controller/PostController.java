...
public class PostController {
    ...
    public PageInfo<PostBizExtDto> getPostList4PageByCond(@ApiParam(required = true,
        value = "查询博文列表的条件") @ModelAttribute @NotNull(message = "请求不能为空") GetPostList4PageByCondRequest req) {
    ...
    public PostBizDto getPostById(@ApiParam(required = true, value = "博文主键") @PathVariable("postId") @NotNull(
        message = "博文id不能为空") @NotBlank(message = "博文id不能为空") Long postId) {
    ...
    @ApiOperation("新增博文")
    public void addPost(
        @ApiParam(required = true, value = "博文实体") @RequestBody @NotNull(message = "请求不能为空") AddPostRequest request) {
    ...
    @ApiOperation("修改博文")
    public PostBizDto updatePost(@ApiParam(required = true,
        value = "博文实体") @RequestBody @NotNull(message = "修改博文请求不能为空") UpdatePostRequest request) {
    ...
    @ApiOperation("删除博文")
    public int deletePost(@ApiParam(required = true, value = "博文主键") @PathVariable("postId") @NotNull(
        message = "博文id不能为空") @NotBlank(message = "博文id不能为空") Long postId) {
