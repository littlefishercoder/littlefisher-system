...
public class SwaggerConfig {
    ...
    public Docket littleFisherApi() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .apis(RequestHandlerSelectors.basePackage("com.littlefisher.web.controller")).paths(PathSelectors.any())
            .build()
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("LittleFisher Blog API").description("LittleFisher Blog后台API调用")
