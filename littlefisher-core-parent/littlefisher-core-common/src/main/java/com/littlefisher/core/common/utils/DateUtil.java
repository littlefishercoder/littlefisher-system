...
import com.littlefisher.core.common.stereotype.enums.EnumSymbol;
...
public final class DateUtil {
     ...
     * DATE_FORMAT_SUPPORT
     */
    public static final String[] DATE_FORMAT_SUPPORT = {DATETIME_FORMAT_1, DATETIME_FORMAT_2, DATETIME_FORMAT_3,
     ...
     * @return java.sql.Date
     */
    public static java.sql.Date getSqlDBDateTime() {
    ...
    private static Date getDBCurrentTime() {
        if (SpringContextUtil.existBean(IDbService.class)) {
            return SpringContextUtil.getBean(IDbService.class).getDBDateTime();
        } else {
            return new Date();
        }
    }
