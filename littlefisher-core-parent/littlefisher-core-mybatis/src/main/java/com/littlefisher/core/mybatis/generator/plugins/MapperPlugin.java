...
import com.littlefisher.core.common.stereotype.enums.EnumBool;
...
public class MapperPlugin extends PluginAdapter {
    ...
    public void setContext(Context context) {
        ...
        if (context.getJdbcConnectionConfiguration() != null) {
            context.getJdbcConnectionConfiguration().addProperty("remarksReporting",
                EnumBool.TRUE.getCode().toLowerCase());
        } else {
            context.getConnectionFactoryConfiguration().addProperty("remarksReporting",
                EnumBool.TRUE.getCode().toLowerCase());
        }
    }
