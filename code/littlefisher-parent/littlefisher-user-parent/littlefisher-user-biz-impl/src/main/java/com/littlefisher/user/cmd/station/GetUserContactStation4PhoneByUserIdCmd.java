...
import com.littlefisher.user.converter.UserContactStation4PhoneDtoConverter;
 ...
 */
@Command
public class GetUserContactStation4PhoneByUserIdCmd extends
        AbstractCommand<List<UserContactStation4PhoneBizDto>> {
