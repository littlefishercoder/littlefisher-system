package com.littlefisher.core.datasource.config;
...
import com.littlefisher.core.datasource.engine.SystemEngineFactoryBean;
...
public class SystemEngineConfig {
     ...
     */
    private com.littlefisher.core.datasource.engine.SystemEngineConfig systemEngineConfig() {
        com.littlefisher.core.datasource.engine.SystemEngineConfig systemEngineConfig = new com.littlefisher.core.datasource.engine.SystemEngineConfig();
