 ...
 * @since v1.0
 */
public class Auto1ServiceImpl implements IProcessAction {
    ...
    /** logger */
    private static Room1000Logger logger = Room1000Logger.getLogger(Auto1ServiceImpl.class);
